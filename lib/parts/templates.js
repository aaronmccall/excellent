(function (root, factory) {
    ...
    templatizer["image"] = function tmpl_image(locals) {
        ...
        (function(description, extent, filename, id, name, namespaces, ns, origin) {
            buf.push('<?xml version="1.0" encoding="UTF-8" standalone="yes"?><xdr:wsDr' + jade.attrs(jade.merge([ namespaces ]), false) + "><xdr:absoluteAnchor><xdr:pos" + jade.attrs(jade.merge([ origin ]), false) + "/><xdr:ext" + jade.attrs(jade.merge([ extent ]), false) + "/><xdr:pic><xdr:cNvPr" + jade.attr("descr", description || filename, true, false) + jade.attr("id", id, true, false) + jade.attr("name", name || "Picture 1", true, false) + '></xdr:cNvPr><xdr:cNvPicPr><a:picLocks noChangeAspect="1"></a:picLocks></xdr:cNvPicPr></xdr:pic><xdr:blipFill><a:blip' + jade.attr("r:embed", "rId" + id, true, false) + jade.attr("xmlns:r", ns.relationships, true, false) + "/><a:stretch><a:fillRect/></a:stretch></xdr:blipFill><xdr:spPr><a:xfrm><a:off" + jade.attrs(jade.merge([ origin ]), false) + "/><a:ext" + jade.attrs(jade.merge([ extent ]), false) + '/></a:xfrm><a:prstGeom prst="rect"><a:avLst></a:avLst></a:prstGeom></xdr:spPr></xdr:absoluteAnchor></xdr:wsDr>');
    ...
    templatizer["styles"] = function tmpl_styles(locals) {
        ...
        var jade_interp;
        var locals_for_with = locals || {};
        (function(Object, attrTags, borders, cellStyles, fills, fonts, key, namespaces, numberFormats, undefined) {
        ...
        }).call(this, "Object" in locals_for_with ? locals_for_with.Object : typeof Object !== "undefined" ? Object : undefined, "attrTags" in locals_for_with ? locals_for_with.attrTags : typeof attrTags !== "undefined" ? attrTags : undefined, "borders" in locals_for_with ? locals_for_with.borders : typeof borders !== "undefined" ? borders : undefined, "cellStyles" in locals_for_with ? locals_for_with.cellStyles : typeof cellStyles !== "undefined" ? cellStyles : undefined, "fills" in locals_for_with ? locals_for_with.fills : typeof fills !== "undefined" ? fills : undefined, "fonts" in locals_for_with ? locals_for_with.fonts : typeof fonts !== "undefined" ? fonts : undefined, "key" in locals_for_with ? locals_for_with.key : typeof key !== "undefined" ? key : undefined, "namespaces" in locals_for_with ? locals_for_with.namespaces : typeof namespaces !== "undefined" ? namespaces : undefined, "numberFormats" in locals_for_with ? locals_for_with.numberFormats : typeof numberFormats !== "undefined" ? numberFormats : undefined, "undefined" in locals_for_with ? locals_for_with.undefined : typeof undefined !== "undefined" ? undefined : undefined);
        return buf.join("");
    };
        ...
        (function() {
            ...
            if ("number" == typeof $obj.length) {
                for (var attr = 0, $l = $obj.length; attr < $l; attr++) {
                    var tag = $obj[attr];
                    if (style[attr]) {
                        buf.push(templatizer["styles"]["attrTag"](attrTags[key], style[attr]));
                    }
                }
            } else {
                var $l = 0;
    ...
    templatizer["worksheet"] = function tmpl_worksheet(locals) {
        ...
        var jade_interp;
        var locals_for_with = locals || {};
        (function(attrTags, cols, dimension, hyperlinks, key, merges, namespaces, panes, part, rows, selection, undefined) {
            ...
            buf.push("</worksheet>");
        }).call(this, "attrTags" in locals_for_with ? locals_for_with.attrTags : typeof attrTags !== "undefined" ? attrTags : undefined, "cols" in locals_for_with ? locals_for_with.cols : typeof cols !== "undefined" ? cols : undefined, "dimension" in locals_for_with ? locals_for_with.dimension : typeof dimension !== "undefined" ? dimension : undefined, "hyperlinks" in locals_for_with ? locals_for_with.hyperlinks : typeof hyperlinks !== "undefined" ? hyperlinks : undefined, "key" in locals_for_with ? locals_for_with.key : typeof key !== "undefined" ? key : undefined, "merges" in locals_for_with ? locals_for_with.merges : typeof merges !== "undefined" ? merges : undefined, "namespaces" in locals_for_with ? locals_for_with.namespaces : typeof namespaces !== "undefined" ? namespaces : undefined, "panes" in locals_for_with ? locals_for_with.panes : typeof panes !== "undefined" ? panes : undefined, "part" in locals_for_with ? locals_for_with.part : typeof part !== "undefined" ? part : undefined, "rows" in locals_for_with ? locals_for_with.rows : typeof rows !== "undefined" ? rows : undefined, "selection" in locals_for_with ? locals_for_with.selection : typeof selection !== "undefined" ? selection : undefined, "undefined" in locals_for_with ? locals_for_with.undefined : typeof undefined !== "undefined" ? undefined : undefined);
        return buf.join("");
    };
        ...
        (function() {
            ...
            if ("number" == typeof $obj.length) {
                for (var attr = 0, $l = $obj.length; attr < $l; attr++) {
                    var tag = $obj[attr];
                    if (style[attr]) {
                        buf.push(templatizer["worksheet"]["attrTag"](attrTags[key], style[attr]));
                    }
                }
            } else {
                var $l = 0;
