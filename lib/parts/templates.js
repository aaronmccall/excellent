(function (root, factory) {
    ...
    templatizer["sharedStrings"] = function tmpl_sharedStrings(locals) {
        ...
        var jade_interp;
        var locals_for_with = locals || {};
        (function(attrTags, count, namespaces, strings, undefined) {
            ...
            buf.push("</sst>");
        }).call(this, "attrTags" in locals_for_with ? locals_for_with.attrTags : typeof attrTags !== "undefined" ? attrTags : undefined, "count" in locals_for_with ? locals_for_with.count : typeof count !== "undefined" ? count : undefined, "namespaces" in locals_for_with ? locals_for_with.namespaces : typeof namespaces !== "undefined" ? namespaces : undefined, "strings" in locals_for_with ? locals_for_with.strings : typeof strings !== "undefined" ? strings : undefined, "undefined" in locals_for_with ? locals_for_with.undefined : typeof undefined !== "undefined" ? undefined : undefined);
        return buf.join("");
    };
    ...
    templatizer["styles"] = function tmpl_styles(locals) {
        ...
        (function(Object, borders, cellStyles, fills, fonts, getCellStyleName, namespaces, numberFormats, numberFormatsBaseId, undefined) {
            buf.push('<?xml version="1.0" encoding="UTF-8" standalone="yes"?><styleSheet' + jade.attrs(jade.merge([ namespaces ]), false) + "><numFmts" + jade.attr("count", numberFormats.length, true, false) + ">");
    ...
    templatizer["worksheet"] = function tmpl_worksheet(locals) {
        ...
        var jade_interp;
        var locals_for_with = locals || {};
        (function(cols, dimension, hyperlinks, merges, namespaces, panes, rows, selection, undefined) {
