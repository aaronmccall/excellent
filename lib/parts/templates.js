...
templatizer["image"] = function tmpl_image(locals) {
    ...
    (function(description, extent, filename, id, name, namespaces, ns, origin) {
        buf.push('<?xml version="1.0" encoding="UTF-8" standalone="yes"?><xdr:wsDr' + jade.attrs(jade.merge([ namespaces ]), false) + "><xdr:absoluteAnchor><xdr:pos" + jade.attrs(jade.merge([ origin ]), false) + "/><xdr:ext" + jade.attrs(jade.merge([ extent ]), false) + "/><xdr:pic><xdr:nvPicPr><xdr:cNvPr" + jade.attr("descr", description || filename, true, false) + jade.attr("id", id, true, false) + jade.attr("name", name || "Picture " + id, true, false) + '/><xdr:cNvPicPr><a:picLocks noChangeAspect="1"/></xdr:cNvPicPr></xdr:nvPicPr><xdr:blipFill><a:blip' + jade.attr("r:embed", "rId" + id, true, false) + jade.attr("xmlns:r", ns.relationships, true, false) + "/><a:stretch><a:fillRect/></a:stretch></xdr:blipFill><xdr:spPr><a:xfrm><a:off" + jade.attrs(jade.merge([ origin ]), false) + "/><a:ext" + jade.attrs(jade.merge([ extent ]), false) + '/></a:xfrm><a:prstGeom prst="rect"><a:avLst/></a:prstGeom></xdr:spPr></xdr:pic><xdr:clientData/></xdr:absoluteAnchor></xdr:wsDr>');
...
templatizer["sharedStrings"] = function tmpl_sharedStrings(locals) {
    ...
    (function(count, namespaces, strings, undefined) {
        jade_mixins["richTextStyle"] = jade_interp = function(style, text) {
            ...
            buf.push("<rFont" + jade.attr("val", style.font || "Calibri", true, false) + "/><family" + jade.attr("val", style.family || 2, true, false) + "/></rPr><t>" + jade.escape((jade_interp = text) == null ? "" : jade_interp) + "</t></r>");
        };
                            ...
                            if ("number" == typeof $$obj.length) {
                                for (var i = 0, $$l = $$obj.length; i < $$l; i++) {
                                    ...
                                    if (part.style) {
                                        ...
                                        buf.push('<r><t xml:space="preserve">' + jade.escape((jade_interp = part.text) == null ? "" : jade_interp) + "</t></r>");
                                    } else {
                                        buf.push("<r><t>" + jade.escape((jade_interp = part.text) == null ? "" : jade_interp) + "</t></r>");
                                    }
                                }
                            } else {
                                var $$l = 0;
...
templatizer["workbook"] = function tmpl_workbook(locals) {
    ...
    (function(definedNames, hasDefinedNames, namespaces, sheets, undefined) {
        buf.push('<?xml version="1.0" encoding="UTF-8" standalone="yes"?><workbook' + jade.attrs(jade.merge([ namespaces ]), false) + '><bookViews><workbookView windowHeight="15360" windowWidth="20480" xWindow="0" yWindow="0"></workbookView></bookViews><sheets>');
        (function() {
            var $$obj = sheets;
            if ("number" == typeof $$obj.length) {
                for (var i = 0, $$l = $$obj.length; i < $$l; i++) {
