...
function getNamespaces(nsCollection) {
    var namespaces = {};
    each(nsCollection, function (ns, key) {
        var keyParts = ['xmlns'];
        if (ns !== '__main') keyParts.push(ns);
        namespaces[keyParts.join(':')] = this[typeof key === 'string' ? key : ns];
    });
    return namespaces;
}
...
relationships.getAttributes = getNamespaces.bind(module.exports);

module.exports = Object.freeze(relationships);